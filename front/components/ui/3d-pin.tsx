...
export const PinContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative min-w-full group/pin z-0  cursor-pointer",
                containerClassName
            )}
        ...
        >
            <div
                ...
                className="absolute left-1/2 w-full top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2"
            >
                <div
                    style={{
                        transform: transform,
                    }}
                    className="absolute left-1/2 p-2 top-1/2 w-full flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700"
                >
